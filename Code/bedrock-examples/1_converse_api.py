...
def use_converse_api():
    bedrock_runtime = boto3.client('bedrock-runtime', region_name=os.getenv("REGION"))  # Use the region from the .env file
    model_id = os.getenv("MODEL_ID") # Replace with your model ARN
